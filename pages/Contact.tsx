  ...
  return (
    <div className="py-16 md:py-24 px-4">
      <div className="max-w-[600px] mx-auto text-center">
        ...
        <p className="text-[#111111]/60 text-lg mb-12 leading-relaxed">
